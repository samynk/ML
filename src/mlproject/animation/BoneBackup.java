 ...
 * @author Koen
 */
public class BoneBackup {

    private BoneBackup parent;
    private String name;
     ...
     */
    private ArrayList<BoneBackup> children = new ArrayList<>();
     ...
     * @param name
     */
    public BoneBackup(String name, Point2D.Double location, double length, double zRotation, String controller, double rotMinimum, double rotMaximum) {
        this.name = name;
        ...
        ParseFCL fclParser = new ParseFCL(controller);
     ...
     * @param parent
     */
    public BoneBackup(String name, Point2D.Double location, double width, double length, double zRotation, String controller, double rotMinimum, double rotMaximum) {
        this.name = name;
        this.location = location;
        this.length = length;
        this.zRot = zRotation * Math.PI / 180.0;
    ...
    public void setParentBone(BoneBackup parent) {
        this.parent = parent;
    }
     ...
     */
    public BoneBackup getParentBone() {
        return parent;
    }
     ...
     */
    public void addChild(BoneBackup bone) {
        children.add(bone);
    ...
    public void update(AnimationTarget target, Point2D.Double toMatch) {
        ...
        this.controller.setFuzzyInput("angle", angle);
        ...
        this.controller.setFuzzyInput("distance", (distance - distance2));
